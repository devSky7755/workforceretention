...
CanvasJS.Chart = (function () {
	...
	Chart.prototype._updateSize = function () {
		return updateCanvasSize.call(this, [this.canvas, this._preRenderCanvas, this.overlaidCanvas, this._eventManager.ghostCanvas]);
	}
	...
	Chart.prototype.setLayout = function () {
		...
		this._preRenderCanvas = !isNullOrUndefined(this._preRenderCanvas) ? this._preRenderCanvas : createCanvas(this.width, this.height);
		this._preRenderCtx = this._preRenderCanvas.getContext("2d");
...
CanvasJS.Chart.version = "v2.3.1 GA";
