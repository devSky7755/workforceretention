  ...
  implements OnInit, AfterViewInit, OnChanges
{
  ...
  getSurvey() {
    ...
    this.employeeService
      .getEmployeeSurveys(this.employeeId)
      .subscribe((data) => {
        ...
        if (this.employeeSurvey) {
          ...
          this.cur_step =
            !this.employeeSurvey.completed &&
            this.employeeSurvey.exit_reason_cur_step
  ...
  setQuestionAnswer() {
    this.answerService
      .getEmployeeSurveyAnswer(this.employeeId, this.surveyId)
      .subscribe((data) => {
